...
**The final paper reviews for all assigned papers must all be submitted using EasyChair.** [EasyChair Link](https://easychair.org/conferences/?conf=cpsc5072025)
...
You are permitted to use AI-based tools in this course. No restrictions are placed on how they are used for any software created to support your course project; the correct runtime behaviour of your programs are your responsibilty regardless of the tools used. With respect to any text-based submissions in this course, specifically the final project report, project reviews, and weekly paper reviews, AI tools can be used to correct _your_ writing, but cannot be used with _any_ text you did not author. Specifically, you are not allowed to provide any text you did not write yourself (e.g., you cannot upload _any_ text fragment or whole paper PDFs) into any tool, AI-based or not. If you (or your team) wrote the content though, you can upload this text to _improve_ your writing. That said, tools _cannot_ be used to do your writing for you. The easiest way to think about this is that no tool should return _more_ text than you uploaded yourself (e.g., suggestions for improvements on an uploaded paragraph is fine, but uploading a couple of bullet points and getting a paragraph back is not allowed). Regardless of the tools used, you are ultimately responsible any text submitted in this course and ensuring it faithfully, completely, and accurately reflects your work.
